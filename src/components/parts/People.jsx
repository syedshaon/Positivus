...
const People = ({ name, title, img, linkedin, desc }) => {
  return (
    <div className={`w-[95%] lg:w-[30%] p-4 border-black border rounded-3xl border-b-4 flex flex-col  items-stretch min-h-[250px]`}>

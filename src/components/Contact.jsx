...
const Contact = () => {
  ...
  function onSubmit(data) {
    const { username, email, bio, type } = data;
    toast({
      title: "You submitted the following values:",
      description: (
        <pre className="mt-2 w-[340px] rounded-md bg-slate-950 p-4">
          <code className="text-white">{JSON.stringify({ username, email, bio, type }, null, 2)}</code>
        </pre>
      ),
    });
  }
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    <FormControl>
                      <RadioGroup onValueChange={field.onChange} defaultValue="sayhi" className="flex   space-y-1">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input defaultValue="" className="border border-csGray" {...field} />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input className="border border-csGray" defaultValue="" {...field} />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea defaultValue="" className="border border-csGray resize-none" {...field} />
                    </FormControl>
